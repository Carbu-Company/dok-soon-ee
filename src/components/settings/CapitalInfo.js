    ...
    <div className="cost-settings">
      ...
      <div className="table-wrap">
        <div className="table-wrap__head">
          <h3 className="table-wrap__subtitle">캐피탈 설정</h3>
          <button 
                  ...
                  <td>
                    <div className="input">
                      <input 
                        ...
                        placeholder="캐피탈명" 
                        value={item.CAPITAL_TITLE || ''}
                        onChange={(e) => handleFieldChange(index, 'CAPITAL_TITLE', e.target.value)}
                  ...
                  <td>
                    <div className="input">
                      <input 
                        ...
                        className={`input__field ${getFieldClassName(index)}`}
                        placeholder="0" 
                        value={item.CAPITAL_RATE || ''}
                        onChange={(e) => handleFieldChange(index, 'CAPITAL_RATE', parseFloat(e.target.value) || 0)}
                      ...
                      <div className="input__utils">
                        <button 
                          type="button" 
                          className="jsInputClear input__clear ico ico--input-delete"
                          onClick={() => handleFieldChange(index, 'CAPITAL_RATE', 0)}
                        >
                          삭제
                        </button>
                      </div>
                  ...
                  <td>
                    <div className="input">
                      <input 
                        ...
                        className={`input__field ${getFieldClassName(index)}`}
                        placeholder="0" 
                        value={item.CAPITAL_AMT || ''}
                        onChange={(e) => handleFieldChange(index, 'CAPITAL_AMT', parseInt(e.target.value) || 0)}
                        readOnly={!isRowEditing(index)}
                      />
                      <div className="input__utils">
                        <button 
                          type="button" 
                          className="jsInputClear input__clear ico ico--input-delete"
                          onClick={() => handleFieldChange(index, 'CAPITAL_AMT', 0)}
                        >
                          삭제
                        </button>
                      </div>
