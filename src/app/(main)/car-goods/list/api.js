...
export const getGoodsFeeCarSumList = async (params) => {
    try {
      const data = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/getGoodsFeeCarSumList`, {
        method: 'POST',
        headers: {
      ...
      console.error("getGoodsFeeCarSumList Error:", error); 
